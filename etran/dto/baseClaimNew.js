...
class BaseClaimNew extends BaseDocument {
    ...
    constructor(req, xmlCfg) {
        ...
        try {
            ...
            //idSm
            if (typeof xmlCfg.claim_root_route.idsm === 'undefined' || xmlCfg.claim_root_route.idsm === "") { this.idSm = getuuid(); }
...
module.exports.BaseClaimNew = BaseClaimNew;