...
exports.baseHandlerNew = async function (message) {


    //console.log(message.value)

    parseString(message.value, function (err, data) {
        console.log(data.requestClaim.claim[0])
    ...
    /*if (!(xmlCfg.claim_root_route === null)) {
        ...
        reg_init.regMessage(claimBase.idSm, 12, req.rawBody, claimBase.checkSum, 0, 1, claimBase.claimStateID, claimBase.claimNumber, claimBase.claimId);
    ...
    // Передача invoice (ГУ-27)
        ...
        reg_init.regMessage(invoiceBase.idSm, invoiceBase.docTypeId, req.rawBody, invoiceBase.checkSum, 0, 1, invoiceBase.invoiceStateID, invoiceBase.invNumber, invoiceBase.invoiceId);
    ...
    //Передача ГУ-46
        ...
        reg_init.regMessage(gu46.idSm, gu46.docTypeId, req.rawBody, gu46.checkSum, 0, 1, gu46.stateTransaction, gu46.docNumber, gu46.docId);
    ...
    //Передача ФДУ-92
        ...
        reg_init.regMessage(fdu92.idSm, fdu92.docTypeId, req.rawBody, fdu92.checkSum, 0, 1, fdu92.stateTransaction, fdu92.docNumber, fdu92.docId);
    ...
    // Передача ГУ-2б
        ...
        reg_init.regMessage(gu2b.idSm, gu2b.docTypeId, req.rawBody, gu2b.checkSum, 0, 1, gu2b.crgStateID, gu2b.docNumber, gu2b.docId);
    ...
    //Передача ГУ-45
        ...
        reg_init.regMessage(gu45.idSm, gu45.docTypeId, req.rawBody, gu45.checkSum, 0, 1, gu45.docStateId, gu45.docNumber, gu45.docId);
